...
void ChameleonWindow::Compile()
{
	...
	{
		wxMessageBox("Please save this file before trying to compile it.", "Unsaved File", wxOK | wxICON_INFORMATION);
...
//////////////////////////////////////////////////////////////////////////////
///  public FocusOnLine
///  Moves the cursor to a given file and line, with an optional
///
